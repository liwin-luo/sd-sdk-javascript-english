...
"object" != typeof JSON && (JSON = {}), function () {
    ...
    var rx_one = /^[\],:{}\s]*$/, rx_two = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, rx_three = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, rx_four = /(?:^|:|,)(?:\s*\[)+/g,
        rx_escapable = /[\\\"\u0000-\u001f\u007f-\u009f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
        rx_dangerous = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, gap, indent, meta, rep;
    ...
    function str(e, t) {
        ...
        switch (d && "object" == typeof d && "function" == typeof d.toJSON && (d = d.toJSON(e)), "function" == typeof rep && (d = rep.call(t, e, d)), typeof d) {
            ...
            case"object":
                ...
                if (rep && "object" == typeof rep) for (n = rep.length, r = 0; r < n; r += 1) "string" == typeof rep[r] && (a = str(s = rep[r], d)) && i.push(quote(s) + (gap ? ": " : ":") + a); else for (s in d) Object.prototype.hasOwnProperty.call(d, s) && (a = str(s, d)) && i.push(quote(s) + (gap ? ": " : ":") + a);
                return a = 0 === i.length ? "{}" : gap ? "{\n" + gap + i.join(",\n" + gap) + "\n" + o + "}" : "{" + i.join(",") + "}", gap = o, a
        }
    }
    ...
    var e, t = Array.prototype, r = Function.prototype, s = Object.prototype, a = t.slice, n = s.toString, i = s.hasOwnProperty, o = (r.bind, t.forEach), d = (t.indexOf, Array.isArray), c = {},
        u = _.each = function (e, t, r) {
            if (null == e) return !1;
            if (o && e.forEach === o) e.forEach(t, r); else if (e.length === +e.length) {
                for (var s = 0, a = e.length; s < a; s++) if (s in e && t.call(r, e[s], s, e) === c) return !1
            } else for (var n in e) if (i.call(e, n) && t.call(r, e[n], n, e) === c) return !1
        };
    _.extend = function (e) {
        ...
        var e = screen.msOrientation || screen.mozOrientation || (screen.orientation || {}).type, t = " Did not take to the value ";
        ...
        r || (r = {});
        var d = function () {
            o = !1 === r.leading ? 0 : _.now(), i = null, n = e.apply(s, a), i || (s = a = null)
        };
        return function () {
            var c = _.now();
            o || !1 !== r.leading || (o = c);
            var u = t - (c - o);
            return s = this, a = arguments, u <= 0 || u > t ? (i && (clearTimeout(i), i = null), o = c, n = e.apply(s, a), i || (s = a = null)) : i || !1 === r.trailing || (i = setTimeout(d, u)), n
        }
        ...
        return e.length > sd.para.max_string_length ? (sd.log("The string length exceeding the limit has been truncated--" + e), e.slice(0, sd.para.max_string_length)) : e
        ...
        for (t = r = 0, s = (e = (e + "").replace(/\r\n/g, "\n").replace(/\r/g, "\n")).length, a = 0; a < s; a++) {
            var i = e.charCodeAt(a), o = null;
            i < 128 ? r++ : o = i > 127 && i < 2048 ? String.fromCharCode(i >> 6 | 192, 63 & i | 128) : String.fromCharCode(i >> 12 | 224, i >> 6 & 63 | 128, 63 & i | 128), null !== o && (r > t && (n += e.substring(t, r)), n += o, t = r = a + 1)
        }
        ...
        var t, r, s, a, n, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", o = 0, d = 0, c = "", u = [];
        if (!(e = String(e))) return e;
        e = _.utf8Encode(e);
        do {
            t = (n = e.charCodeAt(o++) << 16 | e.charCodeAt(o++) << 8 | e.charCodeAt(o++)) >> 18 & 63, r = n >> 12 & 63, s = n >> 6 & 63, a = 63 & n, u[d++] = i.charAt(t) + i.charAt(r) + i.charAt(s) + i.charAt(a)
        } while (o < e.length);
        ...
        var r = e() + "-" + Math.random().toString(16).replace(".", "") + "-" + function (e) {
            var t, r, s = navigator.userAgent, a = [], n = 0;
            ...
            for (t = 0; t < s.length; t++) r = s.charCodeAt(t), a.unshift(255 & r), a.length >= 4 && (n = i(n, a), a = []);
            return a.length > 0 && (n = i(n, a)), n.toString(16)
        }() + "-" + t + "-" + e();
        ...
        try {
            if (e.credentials && (r.withCredentials = !0), _.isObject(e.header)) for (var s in e.header) r.setRequestHeader(s, e.header[s]);
        ...
        for (var t = function (e) {
            ...
            var n = s[a].indexOf("=");
            if (-1 !== n) {
                var i = s[a].substring(0, n), o = s[a].substring(n + 1);
                i = t(i), o = t(o), r[i] = o
            }
        }
        return r
    }, _.URL = function (e) {
        var t, r = {}, s = ["hash", "host", "hostname", "href", "origin", "password", "pathname", "port", "protocol", "search", "username"];
        ...
        switch (typeof t) {
            case"function":
                var r = t();
                return "" === r || "" === _.trim(r) ? "url parse failure" : -1 !== r.indexOf(".") ? r : "url parse failure";
            case"string":
                return "" === t || "" === _.trim(t) ? "url parse failure" : -1 !== t.indexOf(".") ? t : "url parse failure";
            default:
        ...
        return "string" != typeof (e = e || document.referrer) ? " abnormal values_referrer exception  _" + String(e) : (0 === e.indexOf("https://www.baidu.com/") && (e = e.split("?")[0]), "string" == typeof (e = e.slice(0, sd.para.max_referrer_string_length)) ? e : "")
        ...
        if (document && "string" == typeof e) {
            if (0 === e.indexOf("http")) {
                ...
                var a = null;
                for (var n in t) if (r === n && "object" == typeof s) if (a = t[n], _.isArray(a)) for (n = 0; n < a.length; n++) {
                    var i = s[a[n]];
                    if (i) return i
        ...
        var t = "(" + sd.para.source_type.utm.join("|") + ")\\=[^&]+", r = sd.para.source_type.search, s = sd.para.source_type.social, a = document.referrer || "", n = _.info.pageProp.url;
        if (n) {
            var i = n.match(new RegExp(t));
            return i && i[0] ? "Paid AD traffic" : e(r, a) ? "Natural search traffic" : e(s, a) ? "Social network traffic" : "" === a ? " direct traffic" : "Traffic referrals"
        }
        ...
        initPage: function () {
            ...
            for (var n in r) -1 !== (" " + sd.source_channel_standard + " ").indexOf(" " + n + " ") ? s[e + n] = r[n] : a[t + n] = r[n];
    ...
    for (t in sd.para.preset_properties = _.extend({}, sd.para_default.preset_properties, r, sd.para.preset_properties || {}), sd.para_default) void 0 === sd.para[t] && (sd.para[t] = sd.para_default[t]);
    ...
    state: 0, historyState: [], stateType: {1: "1-init NotStarted ", 2: "2-init start ", 3: "3-store  finish  "}, getState: function () {
...
var commonWays = {
    setOnlineState: function (e) {
        ...
        function s() {
            ...
            for (var r in e) -1 !== (" " + sd.source_channel_standard + " ").indexOf(" " + r + " ") ? t["$" + r] = e[r] : t[r] = e[r];
            return t
        }
        ...
        for (var a in r) -1 !== (" " + sd.source_channel_standard + " ").indexOf(" " + a + " ") ? s["$" + a] = r[a] : s[a] = r[a];
        ...
        sd.para.is_single_page && _.addHashEvent(function () {
            ...
            sd.track("$pageview", _.extend({$referrer: r, $url: location.href, $url_path: location.pathname, $title: document.title}, s, e), t), n = location.href
...
sd.quick = function () {
    ...
    "function" == typeof t ? t.apply(sd, r) : sd.log("quick  There is no such function in the method " + e[0])
}, sd.use = function (e, t) {
    ...
    _.isString(e) && ((e = {})[r] = 1), saEvent.check({propertiesMust: e}) && (!function (e) {
        ...
        return !0
    }(e) ? sd.log("profile_increment     values can only be numbers") : saEvent.send({type: "profile_increment", properties: e}, t))
    ...
    }), saEvent.send({type: "profile_unset", properties: s}, t)) : sd.log("profile_unset     The parameter is   array")
    ...
    } else saEvent.check({distinct_id: e}) ? !0 === t ? r ? store.set("first_id", e) : store.set("distinct_id", e) : r ? store.change("first_id", e) : store.change("distinct_id", e) : sd.log("identify     The argument must be a string  ")
    ...
    if (saEvent.check({distinct_id: e, event: t, properties: r})) {
        ...
        store.set("distinct_id", e), saEvent.send({original_id: a, distinct_id: e, type: "track_signup", event: t, properties: r}, s)
    }
    ...
    }, t = _.extend({}, _.info.properties(), sd.store.getProps(), function () {
        var e = _.info.campaignParams(), t = {};
        for (var r in e) -1 !== (" " + sd.source_channel_standard + " ").indexOf(" " + r + " ") ? t["$" + r] = e[r] : t[r] = e[r];
        return t
    }(), e);
    return sd.para.preset_properties.latest_referrer && sd.para.preset_properties.latest_referrer_host && (t.$latest_referrer_host = "" === t.$latest_referrer ? "" : _.getHostname(t.$latest_referrer)), t
    ...
    var e = {
        searchKeywordMatch: location.search.match(/sa-request-id=([^&#]+)/), isSeachHasKeyword: function () {
            ...
            var e = this.searchKeywordMatch, t = location.search.match(/sa-request-type=([^&#]+)/), r = location.search.match(/sa-request-url=([^&#]+)/);
            ...
            sd.para.heatmap_url ? _.loadScript({
                success: function () {
                    setTimeout(function () {
                        "undefined" != typeof sa_jssdk_heatmap_render && (sa_jssdk_heatmap_render(sd, e, t, r), "object" == typeof console && "function" == typeof console.log && (sd.heatmap_version && sd.heatmap_version === sd.lib_version || console.log("heatmap.js and sensorsdata.jsInconsistency of version Numbers can be a risk!")))
                    }, 0)
                }, error: function () {
        ...
        isVtrackMode: !1, loadVtrack: function () {
            _.loadScript({
                ...
                }, type: "js", url: location.protocol + "//static.sensorsdata.cn/sdk/" + sd.lib_version + "/vtrack.min.js"
            })
    ...
    add: function (e) {
        ...
        if (s > 0) if (s <= r) this.send({keys: e.keys, vals: t}); else for (var a = 0; a * r < s; a++) this.send({keys: e.keys.splice(0, r), vals: t.splice(0, r)})
        ...
        for (var e = [], t = [], r = null, s = (new Date).getTime(), a = localStorage.length, n = 0; n < a; n++) {
            ...
            0 === i.indexOf("sawebjssdk-") && /^sawebjssdk\-\d+$/.test(i) && ((r = localStorage.getItem(i)) ? (r = _.safeJSONParse(r)) && _.isObject(r) ? (r._flush_time = s, e.push(i), t.push(r)) : (localStorage.removeItem(i), sd.log("localStorage- data parse exception  " + r)) : (localStorage.removeItem(i), sd.log("localStorage- data  abnormal values" + r)))
        }
...
dataSend.image.prototype.start = function () {
    ...
    var e = this;
    _.ajax({
        url: this.server_url, type: "POST", data: this.data, credentials: !1, timeout: sd.para.datasend_timeout, cors: !0, success: function () {
            e.isEnd()
        }, error: function () {
            e.isEnd()
        }
...
sd.saEvent = saEvent, saEvent.checkOption = {
    ...
    s = -1 !== sd.para.debug_mode_url.indexOf("?") ? sd.para.debug_mode_url + "&data=" + encodeURIComponent(_.base64Encode(e)) : sd.para.debug_mode_url + "?data=" + encodeURIComponent(_.base64Encode(e)), _.ajax({
        ...
        success: function (e) {
            !0 === _.isEmptyObject(e) ? alert("debug data sent successfully " + r) : alert("debug fail    error  reason  " + JSON.stringify(e))
        }
    })
};
var store = sd.store = {
    requests: [], _sessionState: {}, _state: {distinct_id: "", first_id: "", props: {}}, getProps: function () {
        ...
        var e = {}, t = this._state._first_id || this._state.first_id, r = this._state._distinct_id || this._state.distinct_id;
...
sd.bridge = {
    is_verify_success: !1, initPara: function () {
        ...
        "object" == typeof sd.para.app_js_bridge ? sd.para.app_js_bridge = _.extend({}, e, sd.para.app_js_bridge) : !0 === sd.para.use_app_track || !0 === sd.para.app_js_bridge || "only" === sd.para.use_app_track ? (!1 !== sd.para.use_app_track_is_send && "only" !== sd.para.use_app_track || (e.is_send = !1), sd.para.app_js_bridge = _.extend({}, e)) : "mui" === sd.para.use_app_track && (e.is_mui = !0, sd.para.app_js_bridge = _.extend({}, e)), !1 === sd.para.app_js_bridge.is_send && sd.log(" set  is_send:false, if  through failure   the data will be discarded ")
    }, initState: function () {
        function e(e) {
            function t(e) {
...
var heatmap = sd.heatmap = {
    setNotice: function (e) {
        ...
        d = _.extend(d, n), "a" === r && sd.para.heatmap && !0 === sd.para.heatmap.isTrackLink ? _.trackLink({event: e, target: t}, "$WebClick", d) : sd.track("$WebClick", d, i)
        ...
        var e = function () {
            ...
            timeout: 1e3, func: function (e, t) {
                var r = document.documentElement && document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop || 0, s = new Date, a = s - this.current_time;
...
}), "string" == typeof window.sensorsDataAnalytic201505 ? (sd.setPreConfig(window[sensorsDataAnalytic201505]), window[sensorsDataAnalytic201505] = sd, window.sensorsDataAnalytic201505 = sd, sd.init()) : void 0 === window.sensorsDataAnalytic201505 ? window.sensorsDataAnalytic201505 = sd : sd = window.sensorsDataAnalytic201505;
export default sd;